...
(function () {
    ...
    function displayCurrentRecord() {
        ...
        $('#joiningDate').val(contact.joiningDate);
    ...
    ns.save = function () {
        ...
        contact.joiningDate = $('#joiningDate').val();
